...
def main():
    ...
    np.savez('data/NS_data_temp_wp_10RK.npz', params_train_normalized=params_train_normalized, SS_0_train_normalized_neural=SS_0_train_normalized_neural, response_train=response_train,
