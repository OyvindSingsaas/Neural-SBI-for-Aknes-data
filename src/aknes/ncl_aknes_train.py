...
def main():
    ...
    plt.legend()
    #save the plot
    plt.savefig("neural_networks/aknes/sub_model_NS_training_curve.png")
    plt.close()
    ...
    for dim in range(len(l_bounds_NS)):
        ...
        plt.ylabel("True")
        plt.savefig(f"neural_networks/aknes/sub_model_NS_prediction_{dim}.png")
        plt.close()
    ...
    plt.tight_layout()
    plt.savefig("neural_networks/aknes/NCL_NS_performance_test.png")
    plt.close()
    ...
    axs[3].set_title("Confusion Matrix")
    plt.tight_layout()
    plt.savefig("neural_networks/aknes/NCL_NS_performance_train.png")
    plt.close()

    #save full model
    classification_NN_NS.save("neural_networks/aknes/classification_NN_NS.h5")
    ...
    np.save("neural_networks/aknes/platt_scaler_NS.npy", platt_scaler)
